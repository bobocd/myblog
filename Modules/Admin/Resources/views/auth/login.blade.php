...
<head>
    ...
    <title>{{ config('app.name', '荟学习') }}</title>
        ...
        <div class="main-content container-fluid">
            <div class="splash-container">
                <div class="card card-border-color card-border-color-primary">
                    <div class="card-header"><img src="{{asset('theme/beagle/img/logo.png')}}" alt="logo" width="120" height="27" class="logo-img">
                        <span class="splash-description">荟学习CMS管理后台</span></div>
                    <div class="card-body">
                        <form action="/admin/login" method="post">
                            ...
                            <div class="login-form">
                                <div class="form-group">
                                    <input id="name" type="text" name="email"  value='twocars@teah.net' placeholder="系统帐号" autocomplete="off" class="form-control">
                                </div>
                                <div class="form-group">
                                    <input id="password" type="password" name="password" value='123123' placeholder="登录密码" class="form-control">
                                </div>
                                ...
                                <div class="form-group row login-submit">
                                    ...
                                    <div class="col-6">
                                        <span href="/admin/register" class="btn btn-secondary btn-xl" style="background-color:#a49595;color:#c7c2c2">
                                            {{__('Register')}}
                                        </span>
                                    </div>
                                </div>
