...
@section('content')
    <div class="card">
        ...
        <form action="/article/article" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="iscommend" value="1" id="iscommend-1">
                                    <label class="form-check-label" for="iscommend-1">是</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="iscommend" value="0" id="iscommend-0">
